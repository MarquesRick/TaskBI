...
namespace Core.DAL
{
    public abstract class BaseDAL<T> where T : new()
    {
        ...
        protected string GetConnectionStringPostGreSQL()
        {
            var ConnectionString = LeitorConfig.Parametro("conNpgSqlUmov");
            return ConnectionString;
        }

        protected string GetConnectionStringOracle()
        {
            var ConnectionString = LeitorConfig.Parametro("conOracleBI");
            return ConnectionString;
        }
